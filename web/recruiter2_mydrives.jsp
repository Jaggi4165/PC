...
<%@include file='aheader.jsp' %>
    <center>
        ...
        <div>
            <a href="admin_company.jsp"><input type="button" value="<- BACK"></a>
        </div>
    </center>
...
if(user2!=null)
{
    try
    {
        ...
        String query2 = "select * FROM COMPANY_REQUIREMENT WHERE COMPANY_NAME=? or COMPANY_MAIL=?";
        PreparedStatement pst = con2.prepareStatement(query2);
        pst.setString(1,viewcompany);
        ...
        { 
            ...
            %>        
                ...
                <tr align="center">
                    <td colspan="2"><a href="admin_deletedrive.jsp?id=<%=a%>"><input type="button" value="DELETE DRIVE"></a></td>
