...
<script>
    function() {
        ...
        <body>
            <div align="left">
                <a href="Registration_recruiter.jsp"><h2>RECRUITER REGISTRATION</a>
                
            </div>
            
<div class="login">
    <h2 align="center"><b>STUDENT REGISTRATION FORM:STEP-1</b></h2>
    
    <form action="storestudentdetails1.jsp" method="post" onsubmit="return validation()">
<table>
    <table>
            <tr>
                <td>EMAIL</td>
